...
📌 Acerca de
Este repositorio es mi sandbox público. Cada proyecto es un proyecto independiente — un diseño de interfaz, animación, experimento de maquetación o una pequeña herramienta — normalmente inspirada o destacada en alguno de mis vídeos de TikTok. No hay dos proyectos relacionados; Piensa en esto como un archivo en funcionamiento más que como una sola aplicación.

📂 Proyectos
| Proyecto | Descripción | Tecnología utilizada | |---|---|---|---| | Página de inicio de sesión animada | Página de inicio de sesión animada diseñada por desarrolladores para desarrolladores | HTML, CSS, JS |
